...
- [x] standalone `Novation` Intelligent Contract
- [x] no frontend/product surface
- [x] immutable agreement definition + terms digest
- [x] two explicit consent modes
- [x] successor proposal binding to current revision/incumbent
- [x] five-dimension semantic qualification model
- [x] first-class `INCONCLUSIVE`
- [x] independent validator re-fetch and re-reasoning
- [x] quote-grounded conclusive result requirement
- [x] deterministic ratification + activation
- [x] immutable revision-indexed novation lineage
- [x] typed consumer view `is_current_obligor`
- [x] optional cross-contract consumer example
- [x] standard-library deterministic tests
- [x] source/network/security preflight
- [x] Studionet chain `61999` deployment lock
- [x] GenLayer CLI `0.39.1` deployment lock
